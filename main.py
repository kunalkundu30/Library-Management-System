...
Author: Kunal Kundu Date: Feb 10,2024

Description: This script is the main interface for a Library Management System,
handling book and user management tasks like additions, listings, and checkouts.
Designed for modularity, it separates entities and processes into distinct
modules for easy expansion and maintenance, ensuring adaptability for future
enhancements.

Design Comments: - The system uses a straightforward, menu-driven interface for
interaction, ensuring ease of use. - It demonstrates basic principles of
object-oriented design, with classes representing key entities and operations.
"""
...
def main_menu():
    """
    @summary: Displays the main menu and captures user choice. @return(str): The
...
def main():
    """
    @summary: Main application loop, processing user inputs and executing
    ...
    while True:
        ...
        # Checkin (Borrow) book
            ...
            isbn = input_isbn("Enter ISBN: ")
            logging.info(
                f"Attempt made to checkin book with ISBN {isbn} by user with user id {user_id}"
            )
        ...
        # Checkout book (Return)
            ...
            isbn = input_isbn("Enter ISBN: ")
            logging.info(
                f"Attempt made to checkout book with ISBN {isbn} by user with user id {user_id}"
            )
        ...
        # Search operation on book
            ...
            if choice == "1":
                ...
                continue
            logging.info(
                f"Attempt made to search book with {search_field}: {search_query}"
            )
        ...
        # Delete operation on book
            ...
            if choice == "1":
                ...
                continue
            logging.info(
                f"Attempt made to delete book with {search_field}: {search_query}"
            )
        ...
        # Search operation on users
            ...
            if choice == "1":
                ...
                continue
            logging.info(
                f"Attempt made to search user with {search_field}: {search_query}"
            )
        ...
        # Delete operation on user
            ...
            if choice == "1":
                ...
                continue
            logging.info(
                f"Attempt made to delete user with {search_field}: {search_query}"
            )
